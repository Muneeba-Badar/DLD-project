...
HD_PWD='C:/Users/mb08091/Final Project/Final Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_race_game.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_race_game.tcl
