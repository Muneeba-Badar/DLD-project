...
HD_PWD='C:/Users/mb08091/Final Project/Final Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_race_game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_race_game.tcl -notrace
